...
{
    class VaccineData : public acmacs::settings::v3::Data
    {
      public:
        VaccineData()
        {
            ...
            for (const auto& [virus_type, tag] :
                 {pp{"A(H1N1)PDM09"s, "vaccines-A(H1N1)PDM09"sv}, pp{"A(H1N1)"s, "vaccines-A(H1N1)PDM09"sv}, pp{"A(H3N2)"s, "vaccines-A(H3N2)"sv}, pp{"BVICTORIA"s, "vaccines-B/Vic"sv}, pp{"BYAMAGATA"s, "vaccines-B/Yam"sv}}) {
